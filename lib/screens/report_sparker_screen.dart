...
class ReportSparkerScreen extends StatefulWidget {
  const ReportSparkerScreen({super.key});

  @override
  State<ReportSparkerScreen> createState() => _ReportSparkerScreenState();
}

class _ReportSparkerScreenState extends State<ReportSparkerScreen> {
